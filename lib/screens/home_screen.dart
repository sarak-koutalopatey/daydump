...
import 'update_announcement_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    final info = RemoteConfigService.updateInfo;
    if (info.available && RemoteConfigService.claimUpdateScreen()) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        if (!mounted) return;
        Navigator.of(context).push(MaterialPageRoute(
          fullscreenDialog: true,
          builder: (_) => UpdateAnnouncementScreen(info: info),
        ));
      });
    }
  }
